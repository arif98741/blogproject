...
class MenuController extends Controller
{
    public function menuBuilder()
    {
        ...
        return view('back.menu.builder')->with($data);
    }
    ...
    public function index()
    {
        ...
        return view('back.menu.index')->with($data);
    }
    ...
    {
        $data = [];
        return view('back.menu.create')->with($data);
    }
    ...
    public function edit(Request $request, Slider $slider)
    {
        ...
        return view('back.menu.edit')->with($data);
    }
