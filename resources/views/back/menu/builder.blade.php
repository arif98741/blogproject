            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-left">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('admin.menu.index') }}">@lang('Menu') </a>
                        </li>
                        <li class="breadcrumb-item active">@lang('Menu Builder')</li>
                    </ol>
                </div>
                <div class="col-sm-6">
                    <a href="{{ route('admin.menu.index') }}" class="btn btn-primary btn-sm float-sm-right">@lang('Back to
                        Menus')</a>
                </div>
            </div>
        </div>
