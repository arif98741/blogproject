...
')
     ...
     */ 
        ...
        {
                        /** @var \Xenon\LaravelBDSms\Log\Log $instance */
                        return $instance->createLog($data);
        }
                    /**
         * 
         *
         * @return \Illuminate\Database\Eloquent\Model|\Illuminate\Database\Query\Builder|object|\Xenon\LaravelBDSms\Models\LaravelBDSmsLog|null 
         * @version v1.0.35
         * @since v1.0.35
         * @static 
         */ 
        public static function viewLastLog()
        {
                        /** @var \Xenon\LaravelBDSms\Log\Log $instance */
                        return $instance->viewLastLog();
        }
                    /**
         * 
         *
         * @return \Illuminate\Database\Eloquent\Collection|\Xenon\LaravelBDSms\Models\LaravelBDSmsLog[] 
         * @since v1.0.35
         * @version v1.0.35
         * @static 
         */ 
        public static function viewAllLog()
        {
                        /** @var \Xenon\LaravelBDSms\Log\Log $instance */
                        return $instance->viewAllLog();
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Xenon\LaravelBDSms\Log\Log $instance */
                        return $instance->clearLog();
        }
                    /**
         * 
         *
         * @param $provider
         * @return \Illuminate\Database\Eloquent\Builder[]|\Illuminate\Database\Eloquent\Collection|\Illuminate\Support\Collection|\Xenon\LaravelBDSms\Models\LaravelBDSmsLog[] 
         * @since v1.0.35
         * @version v1.0.35
         * @static 
         */ 
        public static function logByProvider($provider)
        {
                        /** @var \Xenon\LaravelBDSms\Log\Log $instance */
                        return $instance->logByProvider($provider);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function logByDefaultProvider()
        {
                        /** @var \Xenon\LaravelBDSms\Log\Log $instance */
                        return $instance->logByDefaultProvider();
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \Xenon\LaravelBDSms\Log\Log $instance */
                        return $instance->toArray($object);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            class LaravelBDSmsLogger extends \Xenon\LaravelBDSms\Facades\Logger {}
